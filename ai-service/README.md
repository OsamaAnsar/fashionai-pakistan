...
Windows setup installs the CUDA 12.1 PyTorch wheel explicitly and pins Diffusers/PEFT versions verified with Python 3.12. The first try-on downloads several gigabytes of cached model weights.
